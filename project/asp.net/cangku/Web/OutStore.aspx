<%@ Page Language="C#" Theme="common" AutoEventWireup="true" CodeFile="OutStore.aspx.cs" Inherits="OutStore" %>
...
<body>
   ...
   <td><asp:TextBox ID="txtProDspt" runat="server" Width="300"></asp:TextBox></td> 
    ...
    <asp:GridView EnableViewState="false" ID="GvProInfo" runat="server" ShowHeader="false" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowDataBound="GvProInfo_RowDataBound">
        <Columns>
             <asp:TemplateField>
                <ItemTemplate>
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    序列号：<asp:TextBox ID="txtBarCode1"  EnableViewState="false" runat="server" Width="300" Text="<%# DataBinder.Eval( Container.DataItem,ShBillListData.MAINBARCODE_FIELD) %>"></asp:TextBox>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField>
                <ItemTemplate>                   
                   <asp:TextBox ID="txtBarCode2" EnableViewState="false" runat="server" Width="10" Visible="false" Text=" <%# DataBinder.Eval( Container.DataItem,ShBillListData.SUBBARCODE_FIELD) %> "></asp:TextBox>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
     ...
     <b>已添加的产品：</b>
     <asp:GridView ID="GvProList" CssClass="Gv1" SkinID="NewSkin" runat="server" AutoGenerateColumns="False" OnRowDeleting="GvProList_RowDeleting" AllowPaging="True" OnPageIndexChanging="GvProList_PageIndexChanging" OnRowDataBound="GvProList_RowDataBound">
         <Columns>
             ...
             <asp:TemplateField HeaderText="产品名称">
                 <ItemTemplate>
                     <asp:HiddenField ID="hidId" runat="server" Value="<%# DataBinder.Eval( Container.DataItem,ShBillListData.ID_FIELD) %>" />                     
   ...
   <tr>
    <td class="CmdRow">
        ...
        <asp:Button ID="Button1" runat="server" Text="返回列表" CausesValidation="false" CssClass="button60" OnClick="Button1_Click" /> 
    </td>
   </tr>
   </table>  
    </form>
