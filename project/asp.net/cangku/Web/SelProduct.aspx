<%@ Page Language="C#" Theme="common"  AutoEventWireup="true" CodeFile="SelProduct.aspx.cs" Inherits="SelProduct" %>
...
<body>
   ...
   <tr>
     <td valign="top">
   <div class="Sdiv">   
   <asp:GridView SkinID="NewSkin" ID="GridView1"  CssClass="Gv1" runat="server" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True"  OnSorting="GridView1_Sorting" OnPageIndexChanging="GridView1_PageIndexChanging" OnSelectedIndexChanging="GridView1_SelectedIndexChanging">
       <Columns>
           ...
           <asp:TemplateField HeaderText="产品名" SortExpression="ProName Desc">
               <ItemTemplate>
                   ...
                   <asp:HiddenField ID="hidProPrice" runat="server" Value="<%# DataBinder.Eval( Container.DataItem,ShProductData.PROPRICE_FIELD) %>" />
